# Wallet-Boost
Wallet-Boost helps end-users take control of MEV outcomes and participate in the MEV market. The below design spec serves as an initial draft of our proposed Wallet-Boost solution. Please comment or add in your feedback and questions!
